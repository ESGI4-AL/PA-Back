...
const createDeliverable = asyncHandler(async (req, res) => {
  ...
  const deliverable = await deliverableService.createDeliverable(projectId, deliverableData, teacherId);
...
const getProjectDeliverables = asyncHandler(async (req, res) => {
  ...
  const deliverables = await deliverableService.getProjectDeliverables(projectId);
